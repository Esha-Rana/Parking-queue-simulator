...
a. To implement a real-world problem (parking lot management) using DSA concepts.
b. To demonstrate the functionality of a circular queue for efficient memory usage.
c. To provide an interactive and visual representation of queue operations using a GUI.
d. To strengthen understanding of queue operations like enqueue, dequeue, and display.
...
a. Efficient memory usage: Unlike a linear queue, circular queue reuses freed slots, preventing   wasted space.
b. Constant time operations: Enqueue and dequeue operations take O(1) time.
c. Realistic simulation: Closely models a parking lot where cars arrive and leave in order.
d. Concept demonstration: Circular queue allows visualization of pointer movement (front and rear), which is essential for DSA understanding.

Why Tkinter Instead of Pygame?
a. No external dependencies required
b. Cross-platform compatibility
c. Sufficient for 2D visualization needs
d. Easier setup for college environment
...
Future improvements
References....left to write more ..functions ko gui ko hola 